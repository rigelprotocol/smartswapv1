 ...
 */
 import {
  ...
  {selectedTokenForModal && !selectedTokenForModal.available && selectedTokenForModal.img ? selectedTokenForModal.img : <NullImage48 />}
    ...
    <NullImage24 /> unknown source
         ...
         <ModalFooter>
             <Button
                 ...
                 onClick={() =>importToken(selectedTokenForModal)}>Import</Button>
         </ModalFooter>
     </ModalContent>
  </Modal> 
